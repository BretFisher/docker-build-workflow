...
2. New in 2025: _Native_ multi-platform building for x86_64 and arm64 on GitHub's Runners (if you need other platforms, there's an example of using QEMU via docker/setup-qemu-action)
